...
function Home() {
  return (
    <>
      <section className="sm:mt-6 lg:mt-5 mt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        <div
          className="my-5 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-10 lg:px-8 xl:mt-10 flex gap-3 lg:flex-justify lg:flex flex-col lg:flex-row">
